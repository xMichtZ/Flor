...
turtle.penup()
turtle.goto(0, -180)
turtle.fillcolor("#FF0000")  # Rojo más claro
turtle.begin_fill()
turtle.circle(0)
turtle.end_fill()
...
# Escribe "Friends" en la parte superior del girasol
turtle.penup()
turtle.goto(0, 100)  # Ajusta la posición vertical según sea necesario
turtle.color("Green")  # Color del texto
turtle.write("PARA: 'JOSE, NATALY , ALEJANDRO , OMAR , Saul'", align="center", font=("Arial", 16, "bold"))
